...
private slots:
    ...
    //senaryo 8: signal week durumu
    void test_zayif_sinyal() {
        SmmManager manager;
        QByteArray mockPacket;
        ...
        //0x10 durumu sinyalin zayıf olduğu anlamına gelir
        mockPacket.append(static_cast <char>(0x10));
        mockPacket.append(static_cast <char>(0x00));
        mockPacket.append(static_cast <char>(0x00));
        mockPacket.append(static_cast <char>(98));
        mockPacket.append(static_cast <char>(0x00));
        mockPacket.append(static_cast <char>(75));
        mockPacket.append(static_cast <char>(0x00));
        mockPacket.append(static_cast <char>(0x00));
        mockPacket.append(static_cast <char>(0x00));
        quint32 sum = 10 + 21 + 16 + 0 + 0 + 98 + 0 + 75 + 0 + 0 + 0;
        mockPacket.append(static_cast <char>(sum & 0xFF));

        manager.injectTestData(mockPacket);

        QCOMPARE(manager.isSignalWeak(), true);
    }
    void test_nabiz_arama(){
        SmmManager manager;
        QByteArray mockPacket;
        ...
        //0x80 durumu cihazın nabız aradığı anlamına gelir
        mockPacket.append(static_cast <char>(0x80));
        mockPacket.append(static_cast <char>(0x00));
        mockPacket.append(static_cast <char>(0x00));
        mockPacket.append(static_cast <char>(0x00));
        mockPacket.append(static_cast <char>(0x00));
        ...
        quint32 sum = 10 + 21 + 128 + 0 + 0 + 0 + 0 + 0 + 0 + 0 + 0;
        mockPacket.append(static_cast <char>(sum & 0xFF));

        manager.injectTestData(mockPacket);

        QCOMPARE(manager.pulseSearch(), true);
    }
 };
